...
draw_radiobutton("settingsfps120", dx + floor(dw * 0.70), dy, 120, (room_speed = 120), action_setting_fps)
tab_next()
dy += 10
...
// FPS values
tab_control_checkbox()
draw_checkbox("settingsfpsvalues", dx, dy, setting_fps_values, action_setting_fps_values)
tab_next()
