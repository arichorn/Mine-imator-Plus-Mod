...
if (filename_ext(fn) = ".midata")
{
	...
	if (ds_map_valid(programmap))
	{
		...
		setting_fps_values = value_get_real(programmap[?"fps_values"], setting_fps_values)
	}
	...
	if (ds_map_valid(rendermap))
	{
		...
		setting_render_watermark_color = value_get_real(rendermap[?"render_watermark_color"], setting_render_watermark_color)
