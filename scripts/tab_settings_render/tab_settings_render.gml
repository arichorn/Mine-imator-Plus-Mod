...
if (setting_render_watermark)
{
	...
	if (!trial_version && checkbox_expand_settings_watermark)
	{
		...
		// Color
		tab_control_meter()
		draw_meter("settingsrenderwatermarkcolor", dx, dy, dw, round(setting_render_watermark_color * 100), 48, 0, 100, 100, 1, tab.render.tbx_watermark_alpha, action_setting_render_watermark_color, capwid)
		tab_next()
