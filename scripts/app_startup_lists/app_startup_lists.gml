...
ds_list_add(videotemplate_list,
	...
	new_videotemplate("avatar_hd", 2048, 2048),
	...
	new_videotemplate("uhd_8k", 7680, 4320),
	...
	new_videotemplate("uhd_8k_cinematic", 8192, 4320)
)
...
ds_list_add(videoquality_list,
	...
	new_videoquality("lower", 350000),
	new_videoquality("lowest", 150000)
)
...
ds_map_add(blend_mode_map, "softlight", array(bm_zero, bm_src_color))
